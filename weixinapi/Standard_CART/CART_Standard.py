...
class CART:
    ...
    def GenerateCART(self,target="dictTree"):
        ...
        if self.decisionTreeType == "Discrete":
            #生成离散特有中间树：cartTree
            self.dictTree = CART_Discrete.GenerateCART(self.dataSource,self.sourceName,self.fields,"dictTree")
        elif self.decisionTreeType == "Continuous":
            self.dictTree = CART_Continuous.GenerateCART(self.dataSource,self.sourceName,self.fields,"dictTree")
        else:
...
if __name__ == '__main__':
    ...
    #control = CART('db','db_dataset.personal_transcripts_cs',fields=['English','CET4','CET6','AdvancedMath','LinearAlgebra','ProbabilityTheory','DataStructure','DataBase','ComputerNetwork','OperatingSystem','CompositionPrinciple','CppProgramming','ProgrammingPractice','JavaProgramming','CSorSE','NCRE_CPP2'])#,'NCRE_NET3'])
    ...
    control = CART('db','db_dataset.personal_transcripts_discrete_cs',fields=['English','CET4','CET6','AdvancedMath','LinearAlgebra','ProbabilityTheory','DataStructure','DataBase','ComputerNetwork','OperatingSystem','CompositionPrinciple','CppProgramming','ProgrammingPractice','JavaProgramming','CSorSE','NCRE_CPP2'])
