...
class C45:
    ...
    def GenerateC45(self,target="dictTree"):
        ...
        if self.decisionTreeType == "Discrete":
            ...
            print({'message':'Generate C45 Error! TreeType "'+self.decisionTreeType+'" can not handle','children':"null"})
            self.dictTree = {'message':'Generate C45 Error! TreeType "'+self.decisionTreeType+'" can not handle','children':"null"}
